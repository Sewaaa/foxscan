    ...
    <div className="max-w-2xl space-y-10">
      ...
      <div>
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-2xl font-bold text-white">Feed RSS</h1>
        </div>
      ...
      <div className="border border-zinc-800 rounded-lg p-6 bg-zinc-900 space-y-4">
        <h2 className="text-sm font-semibold text-zinc-300 uppercase tracking-wide">URL del feed</h2>
        <div className="flex gap-2">
          <code className="flex-1 bg-zinc-950 border border-zinc-700 rounded-md px-4 py-2.5 text-sm text-cyan-400 font-mono truncate">
            {feedUrl || "caricamento…"}
          </code>
          <button
            onClick={copyUrl}
            disabled={!feedUrl}
            className="px-4 py-2.5 bg-cyan-600 hover:bg-cyan-500 disabled:bg-zinc-700 disabled:text-zinc-500 text-white text-sm font-medium rounded-md transition-colors shrink-0"
          >
      ...
      {/* Come si usa */}
      <div className="border border-zinc-800 rounded-lg p-6 bg-zinc-900 space-y-4">
        <h2 className="text-sm font-semibold text-zinc-300 uppercase tracking-wide">Come si usa</h2>
        <ol className="space-y-3 text-sm text-zinc-400">
          ...
          <li className="flex gap-3">
            ...
            Cerca il pulsante <strong className="text-zinc-300">"Add feed"</strong> o{" "}
            <strong className="text-zinc-300">"Subscribe"</strong>.
          </li>
          <li className="flex gap-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {READERS.map((r) => (
            <a
              ...
              className="border border-zinc-800 rounded-lg p-4 bg-zinc-900 hover:border-zinc-600 transition-colors flex items-start gap-3"
            >
              <div className="w-8 h-8 rounded bg-zinc-800 flex items-center justify-center text-sm shrink-0">
                🔖
              </div>
              <div>
