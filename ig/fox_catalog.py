...
TAG_PRIORITY = [
    ...
    ("breach",            ["breach_harddrive", "breach_classified", "breach_vault"]),
    ("leak",              ["breach_vault",     "breach_classified", "breach_harddrive"]),
    ("data breach",       ["breach_harddrive", "breach_vault",     "breach_classified"]),
