...
- cover_title: max 10 parole, titolo giornalistico chiaro e d'impatto. DUE CASI:
  ...
  REGOLE VALIDE PER ENTRAMBI I CASI: MAI usare parole generiche come "Allarme", "Attenzione", "Scoperta", "Violati", "Rubati" come prima parola — sono vuote e ripetitive. Il titolo deve far capire subito di cosa parla la notizia. Usa **grassetto** su 1-2 elementi chiave (nome azienda, numero, nome malware/CVE).
