...
- cover_title: titolo BREAKING NEWS urgente, max 10 parole. REGOLA FONDAMENTALE: metti l'azione ALL'INIZIO, non alla fine. Esempi di struttura vincente: "Sfruttati zero-day per bypassare Defender: 3 nuove falle", "Rubati 13 milioni: exchange crypto violato in poche ore", "Allarme: nuova falla critica espone 200.000 server", "Violata la supply chain: 600 aziende nel mirino", "Bucato il firewall di Cisco: patch urgente disponibile". Parole di apertura (USALE TUTTE, mai ripetere la stessa nei post): Allarme / Violati / Rubati / Sfruttati / Compromessi / Bucato / Attenzione / Scoperta. REGOLA ANTI-RIPETIZIONE TASSATIVA: NON iniziare con "Scoperta" — è già stata usata troppo. Scegli tra le altre opzioni. MAI iniziare con il nome del prodotto/azienda. MAI finire con il verbo. Sempre linguaggio d'azione e urgenza. Usa **grassetto** su 1-2 parole chiave del titolo (numeri, nomi aziende/malware, termini tecnici forti) per evidenziarle graficamente — es: "Violati **3 milioni** di account: falla critica in **LastPass**".
