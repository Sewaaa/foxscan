...
- Ogni testo slide: 2-3 frasi complete e discorsive, non elenchi telegrafici. LIMITE: minimo 80 caratteri, massimo 160 caratteri (spazi inclusi). Conta i caratteri prima di rispondere. OBBLIGATORIO: ogni slide DEVE contenere almeno 1 termine tecnico chiave racchiuso in <strong>termine</strong> per evidenziarlo in azzurro — senza tag <strong> la slide non è valida.
